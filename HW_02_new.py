...
def mean_fare_per_class():
    ...
    df = titanic_df_mean.groupby('Pclass')['Fare'].mean()
...
with DAG(
  ...
  #еще одно
    mean_fare_per_class_n = PythonOperator(
    ...
    first_task >> create_titanic_dataset >> [pivot_titanic_dataset, mean_fare_per_class_n] >> task_last